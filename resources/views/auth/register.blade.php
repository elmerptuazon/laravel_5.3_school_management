            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" autocomplete="off">
                        ...
                        <div class="form-group row">
                                <label for="ident" class="col-md-4 col-form-label text-md-right">{{ __('Ident') }}</label>
    
                                <div class="col-md-6">
                                    <input id="ident" type="text" class="form-control{{ $errors->has('ident') ? ' is-invalid' : '' }}" name="ident" value="{{ old('ident') }}" required>
