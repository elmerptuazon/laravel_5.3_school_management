...
<div class="row">
            ...
            <div class="box-body">
              <div class="row">
                  ...
                  <div class="col-xs-12 col-md-offset-1 col-md-3">
                    ...
                    <input type="number" class="form-control" name="task_total_points" required>
                ...
                <div class="row">
                  <div class="col-xs-12 col-md-3">
                    ...
                    <select class="form-control" name="task_period" required>
                  ...
                  <div class="col-xs-12 col-md-offset-1 col-md-3">
                    ...
                    <select class="form-control schoolYear" name="task_school_year" required>
        ...
        <form method="post" action="{{ route('addscore') }}" role="form">
        @csrf
          <div class="col-md-12">
