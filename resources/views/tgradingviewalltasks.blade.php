                                      ...
                                      <div class="col-xs-12">
                                        ...
                                        <select id="selectSubj" class="form-control" name="subject">
                                          ...
                                          @foreach($tasks_subject_list as $subject)
                                            <option value="{{ $subject->subj }}">{{ $subject->subj }}</option>
                                          @endforeach
                                        </select>
                                        </div>
                                        <div class="col-md-3 col-xs-3">
                                                   ...
                                                   @foreach($student_id_list as $student)
                                                      ...
                                                      <td>{{ ucwords($student->firstname) }} {{ ucwords($student->lastname) }}</td>
                                                            ...
                                                            @isset($transmuting_final_grade)
                                                              @foreach($transmuting_final_grade as $studentid=>$task_list)
                                                                @if($studentid == $student->id)
                                                                    <td style="text-align:center;">{{$task_list}}</td>
                                                                @endif
                                                              @endforeach
...
$(document).ready(function () {
  $('#searchSubmit').on('click', function() {
    ...
    if(strPeriod == '' || strSplit[0] == '' || strSubj == '') {
      ...
      window.location.href = '/fetch/tasks/grades/'+ strSubj + '/' + strSplit[0]+'-'+strSplit[1] + '/' + strPeriod;
    }
